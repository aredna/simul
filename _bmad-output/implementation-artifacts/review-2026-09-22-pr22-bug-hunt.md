...
Still open: the default-state tests and the simplification proposal at the
end of this file. O3 was fixed in D72. P3–P6 are deferred by the owner until one becomes an actual issue
