...
import { localizedLanguageName } from '../../lib/language-options';
...
export interface QuickComposerEnvironment {
  ...
  /** Called whenever the in-flight state changes so the toolbar can re-render. */
 ...
 * the page pair are unchanged when it arrives.
 */
