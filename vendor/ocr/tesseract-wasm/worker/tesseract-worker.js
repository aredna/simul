(function (factory) {
    ...
    async function createOCREngine({ wasmBinary, progressChannel, } = {}) {
        if (!wasmBinary) {
            ...
            // `location.href`.
            const wasmURL = resolve(wasmPath, (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.tagName.toUpperCase() === 'SCRIPT' && document.currentScript.src || document.baseURI)));
